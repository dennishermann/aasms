...
export async function GET(
  ...
  try {
    ...
    return NextResponse.json({ error: "Failed to fetch facet" }, { status: 500 });
  }
}
...
export async function PUT(
  ...
  try {
    ...
    const transformedFacet = {
      ...updatedFacet,
      researchQuestionIds: updatedFacet.researchQuestions.map((frq) => frq.researchQuestionId),
    ...
    return NextResponse.json({ error: "Failed to update facet" }, { status: 500 });
  }
}
...
export async function DELETE(
  ...
  try {
    ...
    return NextResponse.json({ error: "Failed to delete facet" }, { status: 500 });
  }
}
