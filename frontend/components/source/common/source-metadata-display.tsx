    ...
    <CardContent className="space-y-6 pt-6">
      <div className="grid gap-6 md:grid-cols-2">
        {(source.publicationDate ||
          source.metadataExtension?.year ||
          source.metadataExtension?.database_specific?.year) && (
        ...
        {source.greyLiteratureTier && (
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                {GREY_LIT_TIER_LABELS[source.greyLiteratureTier]?.label ||
                  source.greyLiteratureTier}
      ...
      {source.abstract && (
        <div className="border-t pt-4">
          ...
          <div className="relative">
            <p
              className={`text-sm text-muted-foreground leading-relaxed whitespace-pre-wrap ${!isAbstractExpanded ? "line-clamp-3" : ""}`}
            >
              {source.abstract}
            </p>
