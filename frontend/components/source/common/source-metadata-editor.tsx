...
export function SourceMetadataEditor({
  ...
  const [authors, setAuthors] = useState<string[]>(
    source.authors.length > 0 ? source.authors : [""],
  );
    ...
    defaultValues: {
      ...
      year: source.publicationDate
        ...
        : source.metadataExtension?.year
          ? String(source.metadataExtension.year)
          : "",
      venue: source.venue || "",
      doi: source.doi || "",
                  ...
                  <FormItem>
                    ...
                    <Select onValueChange={field.onChange} defaultValue={field.value}>
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="ANALYZING_CLASSIFICATION">
                          Analyzing Classification
                        </SelectItem>
                        <SelectItem value="CLASSIFIED">Classified</SelectItem>
                        <SelectItem value="READY_FOR_CLASSIFICATION">
