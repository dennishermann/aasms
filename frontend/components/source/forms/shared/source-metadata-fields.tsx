    ...
    <Card>
      ...
      <CardContent className="space-y-3">
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel>{sourceType === "pdf" ? "Venue/Source" : "Website/Blog Name"}</FormLabel>
              <FormControl>
                {autoFillLoading ? (
                  <Skeleton className="h-10 w-full" />
                ) : (
                  <Input
                    placeholder={
                      sourceType === "pdf" ? "Conference or journal name" : "Website or blog name"
                    }
                    {...field}
                  />
                )}
                  ...
                  <SelectContent>
                    <SelectItem value="TIER_1">
                      <div className="flex flex-col">
                        ...
                        <span className="text-xs text-muted-foreground">
                          Academic blogs, official industry reports, government docs
                        </span>
                      </div>
                    </SelectItem>
                    <SelectItem value="TIER_2">
                      <div className="flex flex-col">
                        ...
                        <span className="text-xs text-muted-foreground">
                          Company websites, news articles, white papers
                        </span>
                      </div>
                    </SelectItem>
