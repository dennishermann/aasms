        ...
        <CardHeader className="space-y-4 pb-2">
                        ...
                        <DropdownMenuContent align="end">
                            ...
                            <DropdownMenuItem
                                ...
                                disabled={
                                    ...
                                    loadingInclusionAnalysis ||
                                    loadingClassificationAnalysis ||
                                    !["ANALYZING_CLASSIFICATION", "CLASSIFIED", "READY_FOR_ANALYSIS"].includes(source.status)
                                }
                            >
            ...
            <div className="flex flex-col gap-3 pt-2">
                <div className="flex items-center gap-3">
                    <Badge variant="outline" className={source.status === "NEEDS_REVIEW" ? "border-destructive text-destructive" : ""}>
