    ...
    return (
      <div className="text-center py-16 border-2 border-dashed rounded-lg bg-muted/20">
        ...
        <p className="text-muted-foreground max-w-md mx-auto">
          Please add research questions to your study before creating classification facets. Facets
          are linked to research questions to track which aspects of your study each facet
          addresses.
        </p>
      </div>
    );
  ...
  return (
    <div className="text-center py-16 border-2 border-dashed rounded-lg bg-muted/20">
      ...
      <p className="text-muted-foreground max-w-md mx-auto mb-6">
        Facets define the dimensions you&apos;ll use to classify and organize your sources. Create
        facets like &quot;Research Method&quot;, &quot;Publication Type&quot;, or &quot;Application
        Domain&quot;.
      </p>
      {onAddFacet && (
