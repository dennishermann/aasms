      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 max-w-6xl">
        <Card className="border-l-4 border-l-green-500">
          <CardHeader>
            ...
            <CardDescription>Define criteria for including sources in the study</CardDescription>
          </CardHeader>
          <CardContent>
            <CriteriaEditor
              type="inclusion"
        ...
        <Card className="border-l-4 border-l-red-500">
          <CardHeader>
            ...
            <CardDescription>Define criteria for excluding sources from the study</CardDescription>
          </CardHeader>
          <CardContent>
            <CriteriaEditor
              type="exclusion"
