...
class MultiProviderRateLimiter:
    ...
    def get_limiter(self, provider: str, model_name: Optional[str] = None) -> ProviderRateLimiter:
        """
...
def get_rate_limiter(provider: str = "openai", model_name: Optional[str] = None) -> ProviderRateLimiter:
    """
...
def get_openai_limiter(model_name: Optional[str] = None) -> ProviderRateLimiter:
    """Get rate limiter for OpenAI."""
    return get_rate_limiter("openai", model_name)


def get_anthropic_limiter(model_name: Optional[str] = None) -> ProviderRateLimiter:
    """Get rate limiter for Anthropic (Claude)."""
    return get_rate_limiter("anthropic", model_name)


def get_gemini_limiter(model_name: Optional[str] = None) -> ProviderRateLimiter:
